...
def verify(root: Path = ROOT) -> dict[str, Any]:
    ...
    checks={
      ...
      'catalog':(e3.get('deliverable',{}).get('current_bounded_transition')=='rb7-non-termux-runtime-support-disposition' and e3.get('activation',{}).get('accepted_authority_sha256')==EXPECTED_AUTH) or rb7_progression,
      ...
      'register_rb7':(rb7.get('status')=='open-owner-support-disposition' and rb7.get('evidence',{}).get('contract_sha256')==EXPECTED_RB7) or (rb7_progression and rb7.get('status')=='closed-owner-scope-excluded-non-termux-unsupported-not-qualified' and rb7.get('evidence',{}).get('non_termux_android_context_supported') is False),
      ...
      'nonclaims':sb.get('non_termux_android_context_qualified') is False and sb.get('publication_authorized') is False,
    }
