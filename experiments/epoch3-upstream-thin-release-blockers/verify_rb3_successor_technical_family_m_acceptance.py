...
def verify(root:Path=ROOT)->dict[str,Any]:
 ...
 ninth=load(b/'rb5-rb7-runtime-support-policy-correction-temporal-verifier-amendment.json')
 tenth=load(b/'rb1-successor-r3-owner-approval-temporal-verifier-amendment.json')
