...
def verify(root:Path)->dict[str,Any]:
 ...
 rb5_contract=BASE+"rb5-api24-runtime-contract.json";rb4_authority=BASE+"rb4-release-operations-authority.json";rb4_temporal=BASE+"rb4-release-operations-temporal-verifier-amendment.json"
 rb5_scope_authority=BASE+"rb5-api24-support-scope-authority.json";rb5_scope_temporal=BASE+"rb5-api24-support-scope-temporal-verifier-amendment.json";rb6_contract=BASE+"rb6-real-16k-runtime-support-disposition-contract.json"
 ...
 later_progression=rb5_progression or scope_progression
 checks={
  ...
  "state_active_work":state.get("active_work_package") in {BASE+"rb3-successor-technical-family-m-contract.json",BASE+"rb3-successor-legal-family-m-contract.json",BASE+"rb3-successor-legal-data-rebinding-m-contract.json",BASE+"rb3-successor-legal-data-rebinding-m-r1-execution-contract.json",BASE+"rb3-successor-predecessor-supersession-m-contract.json"} or later_progression,
  "state_boundaries":state.get("claim_boundaries",{}).get("successor_stripped_accepted") is True and isinstance(state.get("claim_boundaries",{}).get("successor_technical_family_started"),bool) and isinstance(state.get("claim_boundaries",{}).get("successor_technical_family_accepted"),bool),
  "task_transition":task.get("deliverable",{}).get("current_bounded_transition") in {"rb3-profile-M-successor-technical-family-owner-assembly-and-audit","rb3-profile-M-successor-legal-family-owner-integration-and-audit","rb3-profile-M-successor-legal-data-rebinding-owner-qualification","rb3-profile-M-successor-predecessor-supersession-and-rb3-closure-owner-transition"} or later_progression,
  "task_reads":all(any(x.get("path")==p for x in task.get("required_reads",[])) for p in (BASE+"rb3-successor-stripped-m-r1-return-inspection.json",BASE+"rb3-successor-stripped-m-authority.json",BASE+"rb3-successor-stripped-m-acceptance-contract.json",BASE+"rb3-successor-technical-family-m-contract.json")) or later_progression,
  "task_binds":all(any(x.get("path")==p and x.get("sha256")==sha(root,p) for x in task.get("required_authorities",[])) for p in (BASE+"rb3-successor-stripped-m-r1-return-inspection.json",BASE+"rb3-successor-stripped-m-authority.json")) or later_progression,
