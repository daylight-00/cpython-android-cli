...
def verify(root:Path)->dict[str,Any]:
 ...
 checks={
  ...
  "state_active_work":state.get("active_work_package") in {BASE+"rb3-successor-technical-family-m-contract.json",BASE+"rb3-successor-legal-family-m-contract.json",BASE+"rb3-successor-legal-data-rebinding-m-contract.json"},
