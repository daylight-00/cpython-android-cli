...
def verify(root:Path)->dict[str,Any]:
 ...
 checks={
  ...
  "state_active_work":state.get("active_work_package") in {BASE+"rb3-successor-technical-family-m-contract.json",BASE+"rb3-successor-legal-family-m-contract.json",BASE+"rb3-successor-legal-data-rebinding-m-contract.json",BASE+"rb3-successor-legal-data-rebinding-m-r1-execution-contract.json"},
  ...
  "task_transition":task.get("deliverable",{}).get("current_bounded_transition") in {"rb3-profile-M-successor-technical-family-owner-assembly-and-audit","rb3-profile-M-successor-legal-family-owner-integration-and-audit","rb3-profile-M-successor-legal-data-rebinding-owner-qualification"},
