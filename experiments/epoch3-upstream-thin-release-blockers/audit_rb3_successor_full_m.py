...
def audit(result_dir: Path) -> dict[str, Any]:
    ...
    audit_checks = {
        ...
        "native_wheel_build_recorded": wheel.get("pass") is True and isinstance(wheel.get("raw_extension"), dict),
        "explicit_wheel_normalization_pass": wheel.get("explicit_normalization", {}).get("import_returncode") == 0,
