...
def main():
 ...
 ck('experiment_readme_selected',SECOND_HEAD in texts['readme'] and 'input capture pending' in texts['readme'])
 ck('root_readme_gate4a','CPython 3.14.5' in texts['root_readme'] and 'Gate 4A' in texts['root_readme'])
 ck('context_gate4a','CPython 3.14.5' in texts['context'] and 'A1' in texts['context'] and 'A6' in texts['context'])
 ...
 ck('ledger_design_entry','Gate 4A — second-product authority acquisition design' in texts['ledger'] and 'input capture pending' in texts['ledger'])
