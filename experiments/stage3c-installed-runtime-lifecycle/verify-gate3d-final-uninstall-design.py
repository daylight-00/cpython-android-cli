...
def main()->int:
 ...
 ck('handoff_design_frozen','DESIGN FROZEN' in texts['handoff'] and '44' in texts['handoff'])
 ck('scope_design_frozen','Gate 3D' in texts['scope'] and 'DESIGN FROZEN' in texts['scope'])
