...
def main()->int:
 ...
 ck('handoff_design_frozen','Frozen design result' in texts['handoff'] and '44' in texts['handoff'] and 'FROZEN PASS' in texts['handoff'])
 ck('scope_design_frozen','Frozen Gate 3D' in texts['scope'] and 'design 108/108' in texts['scope'] and 'Gate 4' in texts['scope'])
 ck('handoff_readme_design_frozen','Gate 3D final uninstall design' in texts['handoff_readme'] and 'FROZEN 108/108' in texts['handoff_readme'])
 ck('experiment_readme_design_frozen','Gate 3D final runtime-base uninstall design' in texts['experiment_readme'] and 'FROZEN 108/108' in texts['experiment_readme'])
 ...
 ck('gate4_deferred_docs','Gate 4 remains deferred' in texts['design'] and 'No Gate 4 target claim' in texts['handoff'] and 'target acceptance policy remain unclaimed' in texts['scope'] and 'No upgrade/downgrade matrix or target claim is frozen' in texts['handoff_readme'])
