...
> **Status:** DESIGN FROZEN — implementation and target evidence pending
...
Gate 4D  bidirectional Termux target validation   pending
Gate 4E  independent transition freeze            pending
```

Gate 4C may implement only this design. A design change requires a new authority decision rather than silent implementation drift.
